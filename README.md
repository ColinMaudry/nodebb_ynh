...
> *This package allows you to install NodeBB 3.x quickly and simply on a YunoHost server.*
> *It will not move to v4.x. For NodeBB 4.x check the original repo: https://github.com/ColinMaudry/nodebb_ynh*  
